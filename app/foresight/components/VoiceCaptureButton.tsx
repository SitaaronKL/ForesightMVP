    ...
    <>
          ...
          >
            <DropdownMenuTrigger asChild>
              <button
                ...
                aria-label="Call"
                className="inline-flex items-center gap-2 rounded-[100px] bg-foresight text-white py-2 text-sm font-medium hover:bg-foresight-dark transition shadow-sm flex-shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-foresight/40 px-3 @[700px]:px-5"
              >
                <PhoneCallIcon
                  ref={phoneRef}
                  size={16}
      ...
      {recording && (
        <button
          ...
          className="inline-flex items-center gap-2 rounded-[100px] bg-red-warning text-white py-2 text-sm font-medium hover:bg-red-700 transition shadow-sm flex-shrink-0 px-3 @[700px]:px-5"
        >
      ...
      {processing && (
        <div className="inline-flex items-center rounded-[100px] bg-brand-100 text-brand-700 py-2 text-sm flex-shrink-0 px-3 @[700px]:px-5">
